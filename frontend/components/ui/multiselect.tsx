      ...
      >
        <div className="flex flex-wrap gap-1">
          ...
          <CommandPrimitive.Input
            ...
            className={cn(
              "flex-1 bg-transparent outline-hidden placeholder:text-muted-foreground/40 disabled:cursor-not-allowed",
              {
